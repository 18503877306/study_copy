...
.img404 {PADDING-RIGHT: 0px; PADDING-LEFT: 0px; BACKGROUND: url(/js-library/valid/err.gif) no-repeat left top; FLOAT: left; PADDING-BOTTOM: 0px; MARGIN: 0px; WIDTH: 80px; PADDING-TOP:0px; POSITION: relative; HEIGHT: 90px; margin-top:10px;}
...
#ShowTime { font-size:14px; color:#F00; font-weight:bold;}
...
<H1 class=hidehr>对不起，系统出错咯！！！</H1>
<DIV class=img404>　</DIV>
<H2>对不起，系统出错咯！！！</H2>
<H3 class=wearesorry></H3>
<DIV class=content>对不起，你所访问的页面发生了错误。原因可能的是： 
  <UL>
  <LI><div id="errorCode"/> </LI>
  <LI><div id="errorMsg"/> </LI>
</UL>
<br />
<STRONG>您可以点击以下链接继续浏览本站的其它内容</STRONG>： 
<DIV class=show14>
<UL>
