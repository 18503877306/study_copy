	...
	<form id="ff" action = "saveTqSysVerifyResource" method="post">
		<table>
				<%-- <tr>
					<td>业务资料配置ID</td>
					<td>
						<input type="text" name="verifyCfgId" id="verifyCfgId" class="dfinput" readonly
				...
				<tr name = "effect" id= "effect" style="display:none">
					<td>生效时间</td>
					<td>
						<input type="text" name="birthday" plugin="datepicker"
						value="${tqSysVerifyCfg.effectTime}" />
					</td>
				</tr>
				<%-- <tr>
					<td>失效时间</td>
		...
		<input name="" type="submit" class="btn" value="增加"/>
	</form>
</body>
